...
if (m.money) m.reply(+m.money + ' ⠀Ｓｏｌｅｓ 𝙪𝙨𝙖𝙙𝙤𝙨') 
}
break
}}} catch (e) {
console.error(e)
...
if (!m.fromMem && m.text.match(/(@5492266486080|Bot|si|hola|:v)/gi)) {
let emot = pickRandom(["😺", "😸", "😹", "😻", "😼", "😽", "🙀", "😿", "😾", "🤩", "😏", "😳", "🥵", "🤯", "😱", "😨", "🤫", "🥴", "🤧", "🤑", "🤠", "🤖", "🤝", "💪", "👑", "😚", "🐱", "🐈", "🐆", "🐅", "⚡️", "🌈", "☃️", "⛄️", "🌝", "🌛", "🌜", "🍓", "🍎", "🎈", "🪄", "❤️", "🧡", "💛", "💚", "💙", "💜", "🖤", "🤍", "💘", "💝", "💟", "🌝", "😎", "🔥", "🖕", "🐦"])
this.sendMessage(m.chat, { react: { text: emot, key: null }})}
...
export async function callUpdate(callUpdate) {
    ...
    let vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;⠀𝘽𝙤𝙩-𝙈𝘿 👑;;;\nFN:⠀𝘽𝙤𝙩-𝙈𝘿\nORG:⠀𝘽𝙤𝙩-𝙈𝘿 👑\nTITLE:\nitem1.TEL;waid=573147616444:+57 314 7616444\nitem1.X-ABLabel:⠀𝘽𝙤𝙩-𝙈𝘿 👑\nX-WA-BIZ-DESCRIPTION:[❗] ᴇsᴄʀɪʙɪ sᴏʟᴏ ᴘᴏʀ ᴄᴏsᴀs ᴅᴇʟ ʙᴏᴛ.\nX-WA-BIZ-NAME:⠀𝘽𝙤𝙩-𝙈𝘿 👑\nEND:VCARD`
    await this.sendMessage(nk.from, { contacts: { displayName: '⠀𝘽𝙤𝙩-𝙈𝘿 👑', contacts: [{ vcard }] }}, {quoted: callmsg})
...
let imgs = 'https://files.catbox.moe/skhywv.jpg';
let mjs = 'https://wa.me/51935848195?text=Hola%20Me%20interesa%20el%20CHATBOT%20más%20info%20🙂';
global.dfail = async (type, m, conn, usedPrefix) => { // Añadido async
    let fkontak = { 
        "key": { 
    ...
    let msg = {
        ...
        private: '[❗] Este comando, Es solo al privado del bot',
        admin: '[❗] Este comando solo puede ser utilizado por administradores del grupo',
        botAdmin: '[❗] Este comando solo se puede usar cuando el bot se convierte en administrador',
        unreg: '「ESPERA PE, NO ESTAS REGISTRADO」\n\nPara poder usarme escribe el siguiente comando\n\nComando: #reg nombre.edad\nEjemplo: #reg MediaHub.20',
        restrict: '[ 🔐 ] Este comando está desactivado por mi jefe'
    }[type]
    
    if (msg) {
        return await conn.sendButton(m.chat, msg, 'ESCRIBE AL CHAT DEL BOT', imgs, [
['', `.lk`],
['', `kkk`]], null, [['IR AL CHAT 📝', `${mjs}`]], fkontak)
    }
}
/*
global.dfail = (type, m, conn, usedPrefix) => {
    ...
    if (msg) return conn.sendMessage(m.chat, {text: msg,  contextInfo: {externalAdReply : {mediaUrl: null, mediaType: 1, description: null, "title": `❗️𝙽𝙾𝚃𝙰 📝`, body: wm, previewType: 0, "thumbnail": img.getRandom(), sourceUrl: [nna, md, yt, nn, tiktok].getRandom()}}}, { quoted: m })
}
*/
